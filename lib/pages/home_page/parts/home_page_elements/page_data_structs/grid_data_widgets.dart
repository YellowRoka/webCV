      ...
      children: [
        Column(
          ...
          children: [
            ...
            const SizedBox( height: 10 ), JobCard( description: jsonDataPack.jobsEN.jobs[ 8 ], width: 700 ),
          ]
        ),
      ...
      children: [
        Column(
          ...
          children: [
            ...
            const SizedBox( height: 10 ), JobCard( description: jsonDataPack.jobsHU.jobs[ 8 ], width: 700 ),
          ]
        ),
